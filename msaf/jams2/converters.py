...
def main():
	...
	fname = '/Users/mitian/Documents/experiments/msaf-devel/datasets/BeatlesTUT/estimations_f_hpcp_bid_cnmf/01AHardDaysNight.jams'
	times = load_jams_range(fname, 'sections', annotator=0, annotator_name=None, converter=None, context='large_scale', confidence=False)
