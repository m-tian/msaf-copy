...
class AnnotationSet(list):
	...
	def __init__(self, annotations=None, DefaultType=Annotation):
		...
		# The annotation argument is correctedly passed. self._DefaultType(**obj) doesn't work.
...
class Jams(JSONType):
	...
	def __init__(self, beats=None, chords=None, melody=None, notes=None,
		...
		# Nothing appears since here. AnnotationSet(sections, RangeAnnotation) is not working.
		if beats is None:
			beats = list()
		if chords is None:
			chords = list()
