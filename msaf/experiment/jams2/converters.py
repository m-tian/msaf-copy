...
There seems to have a bug in load_jams_range. When loading from qupujicheng
"""
...
def main():
	...
	fname = '/Users/mitian/Documents/experiments/msaf-devel/datasets/BeatlesTUT/references/01AHardDaysNight.jams'
	times, labels = load_jams_range(fname, 'sections', annotator=0, annotator_name=None, converter=None, context='large_scale', confidence=False)
	print times, labels
