...
// mi: 1. use more advanced HMM algorithms. 2. try different clustering rechniques.
					 ...
					 int histogram_length, int nclusters, int neighbour_limit)
{
	...
	// mi: modify from here! -- replace with continuous hmm.
...
*/
	...
	// mi: use PDFs to replace histograms
