...
def compute_beat_sync_features(features, beats_idx):
	...
	bs_gmt = librosa.feature.sync(features["gmt"].T, beats_idx, pad=False).T
	return bs_mfcc, bs_hpcp, bs_tonnetz, bs_cqt, bs_gmt
